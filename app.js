'use strict';
  ...
  function _fecharGamesHub() {
    ...
    if (typeof _vooParar === 'function') _vooParar();
    var hub = document.getElementById('games-hub');
    if (!hub) return;
  ...
  function _vooPreparar() {
    ...
    if (!_vooResizeOn) {
      window.addEventListener('resize', function () {
        if (_gamesHubAberto && _gamesHubAberto()) { _vooDimensionar(); if (_vooEstado !== 'jogando') _vooDrawIdle(); }
      });
      _vooResizeOn = true;
    }
    _vooEstado = 'inicio';
  ...
  function _vooFim() {
    ...
    if (typeof rankSubmeter === 'function') rankSubmeter('voo', score);
    ...
    if (typeof rankFimDeJogo === 'function') rankFimDeJogo('voo', 'vo-rank-slot', score);
  }
